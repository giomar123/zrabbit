...
export async function createPurchaseTicketPdf(input: PurchaseTicketInput): Promise<Buffer> {
  ...
  totalLine("Subtotal", formatPen(totals.subtotalInCents)); totalLine("IGV (22%) incluido", formatPen(totals.igvInCents)); totalLine("Envío", ticketShippingLabel(input));
