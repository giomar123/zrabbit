...
import { AdminSalesSyncAlert } from "./components/AdminSalesSyncAlert";
import { AdminOrderDetailDrawer } from "./components/AdminOrderDetailDrawer";
import { AdminMobileEditorHelper } from "./components/AdminMobileEditorHelper";

function AdminWithCatalogActions() { return <><Admin /><AdminSalesSyncAlert /><AdminCatalogActions /><AdminOrderDetailDrawer /><AdminMobileEditorHelper /></>; }
