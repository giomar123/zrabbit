...
function Router() { return <Switch><Route path="/" component={Home} /><Route path="/catalogo">{() => <Storefront catalogueMode />}</Route><Route path="/productos/:slug">{params => <ProductDetail slug={params.slug} />}</Route><Route path="/carrito" component={Cart} /><Route path="/terminos-y-envios" component={TermsAndShipping} /><Route path="/admin/login" component={AdminLogin} /><Route path="/admin" component={AdminWithCatalogActions} /><Route path="/404" component={NotFound} /><Route component={NotFound} /></Switch>; }
